...
public class T19_SumOfAllDataAtKthLevel extends T04_LevelOrderTreeBuilt<Integer> {
    ...
    public int summation(int level){
        ...
        int sum=0;
        Queue<T01_Node<Integer>> queue=new LinkedList<>();
        queue.add(root);
        queue.add(null);
    ...
    public static void main(String[] args) {
        T19_SumOfAllDataAtKthLevel sumOfAllDataAtKthLevel=new T19_SumOfAllDataAtKthLevel();
